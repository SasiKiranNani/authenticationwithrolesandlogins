...
<?php endif; ?>
             ...
             <div
                style="margin-top: 10px; gap: 20px; display: flex; justify-content: center; text-align: center;align-items: center;">
                <a style="background-color: #ff0000c7; padding:5px; color:white;" href="<?php echo e(route('auth.google')); ?>">Login
                    Using Google</a>

                <a style="background-color: #0376adfc; padding:5px; color:white;" href="<?php echo e(route('auth.facebook')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\Sunseaz\Desktop\PHP LARAVEL\laravel projects\authenticationwithrolesandlogins\resources\views\auth\login.blade.php ENDPATH**/ ?>