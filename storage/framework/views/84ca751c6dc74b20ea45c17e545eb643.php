...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => ''.e(route('user-dashboard')).'','active' => request()->routeIs('user-dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => ''.e(route('user-dashboard')).'','active' => request()->routeIs('user-dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\Users\Sunseaz\Desktop\PHP LARAVEL\laravel projects\authenticationwithrolesandlogins\resources\views/navigation-menu.blade.php ENDPATH**/ ?>